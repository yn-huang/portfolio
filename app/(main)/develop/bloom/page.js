...
const metadata = {
  ...
  liveLinkDescription: "(only available to UNC campus VPN)",
  rightNav: "Learn Hub",
  rightLink: paths.develop.learn_hub,
  leftNav: "",
  leftLink: "",
};
      ...
      <article>
        ...
        >
          <Overview
            ...
            ref={overviewRef}
          >
            Bloom is an award-winning process mapping SPA that assists research
            teams in understanding and navigating the steps required to initiate
            clinical research studies (<a href="https://www.centerwatch.com/articles/26591-uncs-study-startup-mapping-tool-wins-wcg-innovation-challenge">Innovation Challenge at the 2023 MAGI
            East Clinical Research Conference</a>). I developed both the
